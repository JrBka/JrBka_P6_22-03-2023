...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 08 mai 2023 à 18:32
...
('DoctrineMigrations\\Version20230418111356', '2023-04-18 13:14:09', 82),
('DoctrineMigrations\\Version20230419200140', '2023-04-19 22:01:52', 8);
...
CREATE TABLE `trick` (
  ...
  `tricks_group` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pictures` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '(DC2Type:json)',
  `videos` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '(DC2Type:json)',
  `created_at` datetime NOT NULL COMMENT '(DC2Type:datetime_immutable)',
